...
def test_data_array_stacker_fit_transform(
    ...
    stacked = stacker.fit_transform(mock_data_array_full_dimensional_nans, dim_sample, dim_feature)
    unstacked = stacker.inverse_transform_data(stacked)
    ...
    stacked = stacker.fit_transform(mock_data_array_boundary_nans, dim_sample, dim_feature)
    unstacked = stacker.inverse_transform_data(stacked)
