...
from .test_mca_data_container import test_mca_data_container_init, test_mca_data_container_set_data, test_mca_data_container_no_data, test_mca_data_container_set_attrs
...
def test_mca_rotator_data_container_set_data(sample_input_data, sample_components, sample_scores, sample_squared_covariance, sample_total_squared_covariance, sample_idx_modes_sorted, sample_norm, sample_rotation_matrix, sample_phi_matrix, sample_modes_sign):
    ...
    test_mca_data_container_set_data(sample_input_data, sample_components, sample_scores, sample_squared_covariance, sample_total_squared_covariance, sample_idx_modes_sorted, sample_norm)  # Re-use the test from MCADataContainer.
...
def test_mca_rotator_data_container_set_attrs(sample_input_data, sample_components, sample_scores, sample_squared_covariance, sample_total_squared_covariance, sample_idx_modes_sorted, sample_norm, sample_rotation_matrix, sample_phi_matrix, sample_modes_sign):
    '''Test the set_attrs() method of MCARotatorDataContainer.'''
    data_container = MCARotatorDataContainer()
    data_container.set_data(sample_input_data, sample_input_data, sample_components, sample_components, sample_scores, sample_scores, sample_squared_covariance, sample_total_squared_covariance, sample_idx_modes_sorted, sample_modes_sign, sample_norm, sample_norm, sample_rotation_matrix, sample_phi_matrix)
    data_container.set_attrs({'test': 1})
    
    test_mca_data_container_set_attrs(sample_input_data, sample_components, sample_scores, sample_squared_covariance, sample_total_squared_covariance, sample_idx_modes_sorted, sample_norm)  # Re-use the test from MCADataContainer.
