...
.. "auto_examples/1eof/plot_weighted-eof.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_1eof_plot_weighted-eof.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_1eof_plot_weighted-eof.py:
...
.. image-sg:: /auto_examples/1eof/images/sphx_glr_plot_weighted-eof_001.png
   :alt: (1) Covariances, (2) Covariances + coslat, (3) Correlation, (4) Correlation + coslat
   :srcset: /auto_examples/1eof/images/sphx_glr_plot_weighted-eof_001.png
...
.. _sphx_glr_download_auto_examples_1eof_plot_weighted-eof.py:
