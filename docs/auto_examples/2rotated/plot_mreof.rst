...
.. "auto_examples/2rotated/plot_mreof.py"
...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_2rotated_plot_mreof.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_2rotated_plot_mreof.py:
...
.. image-sg:: /auto_examples/2rotated/images/sphx_glr_plot_mreof_001.png
   :alt: Mode 1, Subset 1, Subset 2, Subset 3, Subset 4
   :srcset: /auto_examples/2rotated/images/sphx_glr_plot_mreof_001.png
...
.. _sphx_glr_download_auto_examples_2rotated_plot_mreof.py:
